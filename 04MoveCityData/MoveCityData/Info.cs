...
namespace MoveCityData
{
    ...
    public class DtDeptList
    {
        public string City { get; set; }

        public List<DtDept> DtDepts { get; set; }
    }

    public class DtEmplList
    {
        public string City { get; set; }

        public List<DtEmpl> DtEmpls { get; set; }
    }

    public class DtEmplMapList
    {
        public string City { get; set; }

        public List<DtEmplMap> DtEmplMaps { get; set; }
    }
    ...
    public class DtDept
    {
        ...
        public string SORTING1 { get; set; }
    ...
    public class DtEmpl
    {
        ...
        public string RADIOKIND1 { get; set; }

        public string RADIOKIND2 { get; set; }
        ...
        public float ERRORTIMES { get; set; }
